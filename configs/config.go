...
var FileStoragePath = ""
var DataBaseDSN     = "postgres://postgres:password@localhost:5432/shortener"
...
type Config struct {
	...
	DataBaseDSN     string `env:"DATABASE_DSN"       envDefault:"postgres://postgres:password@localhost:5432/shortener"`
}
