...
var FileStoragePath = ""
var DataBaseDSN = "postgres://postgres:postgres@postgres:5432/shortener?ssl=disable"
...
type Config struct {
	...
	DataBaseDSN     string `env:"DATABASE_DSN"       envDefault:"postgres://postgres:postgres@postgres:5432/shortener?ssl=disable"`
}
